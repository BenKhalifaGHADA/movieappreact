  ...
  handleCreate = () => {
    ...
    form.validateFields((err, values) => {
      ...
      this.setState({
        ...
        // new_title: this.values.Title,
        // new_date: this.values.date,
        // new_rate: parseInt(this.values.rate),
        // new_url: this.values.Title,
        // movies: this.state.movies.concat(this.state.id,this.state.new_url,this.state.new_title,this.state.new_date,this.state.new_rate)
      });
  ...
  render() {
    ...
    return (
      <div className="App" style={{ background: '#ECECEC', padding: '30px' }}>
        ...
        <main>
          <Card data={this.state.movies} onaddnewMovie={(ch) => this.addnewMovie(ch)} />
